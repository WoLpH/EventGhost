...
SetupDiGetSelectedDriverW.argtypes = [
    HDEVINFO, PSP_DEVINFO_DATA, PSP_DRVINFO_DATA_W
]
...
SetupDiGetDeviceInstallParamsW.argtypes = [
    HDEVINFO, PSP_DEVINFO_DATA, PSP_DEVINSTALL_PARAMS_W
]
...
SetupDiOpenDeviceInfoW.argtypes = [
    HDEVINFO, PCWSTR, HWND, DWORD, PSP_DEVINFO_DATA
]
...
SetupDiEnumDriverInfoW.argtypes = [
    HDEVINFO, PSP_DEVINFO_DATA, DWORD, DWORD, PSP_DRVINFO_DATA_W
]
...
SetupDiEnumDeviceInterfaces.argtypes = [
    HDEVINFO, PSP_DEVINFO_DATA, POINTER(GUID), DWORD, PSP_DEVICE_INTERFACE_DATA
]
...
PSP_DEVICE_INTERFACE_DETAIL_DATA_W = POINTER(
